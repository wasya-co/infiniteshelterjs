        ...
        data.map((newsitem, i) => {
          ...
          return (
            <div key={i} className={`items premium-${newsitem.premium_tier || 0}`}>
              {
                newsitem.item_type == "report" ?
                  <NewsItemReport data={newsitem} icon={icon} /> :
                  newsitem.item_type == "video" ?
                    <NewsItemVideo data={newsitem} icon={icon} /> :
                    newsitem.item_type == "gallery" ?
                      <NewsItemGallery data={newsitem} icon={icon} /> :
                      null
              }
            </div>
          )
